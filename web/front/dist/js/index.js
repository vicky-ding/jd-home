...
var _otherapp = __webpack_require__(33);

var _otherapp2 = _interopRequireDefault(_otherapp);

var _splike = __webpack_require__(35);

var _splike2 = _interopRequireDefault(_splike);

var _more = __webpack_require__(37);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(_splike2.default, { source: 'http://localhost:3000/data/spike' }),
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(0),m=__webpack_require__(9),p=__webpack_require__(4),v=__webpack_require__(2),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(6);
...
var ComponentSearch = function (_Component) {
    ...
    function ComponentSearch() {
        ...
        var _this = _possibleConstructorReturn(this, (ComponentSearch.__proto__ || Object.getPrototypeOf(ComponentSearch)).call(this));
    ...
    _createClass(ComponentSearch, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { id: 'search', className: 'pf', style: { background: this.state.bg } },
                _react2.default.createElement(
                    'div',
                    { className: 'search pr' },
                    _react2.default.createElement(
                        'div',
                        { className: 'search-logo pa' },
                        _react2.default.createElement('i', null)
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'search-body pr' },
                        _react2.default.createElement('span', { className: 'search-body-bar pa' }),
                        _react2.default.createElement('input', { placeholder: '\u5168\u573A\u7545\u996E\uFF0C\u90E8\u5206\u4F4E\u81F399\u51CF50', type: 'text' })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'search-login pa' },
                        '\u767B\u5F55'
                    )
                )
            );
...
var _jsonp = __webpack_require__(3);
...
var ComponentHeader = function (_Component) {
    _inherits(ComponentHeader, _Component);
    ...
    _createClass(ComponentHeader, [{
        ...
        value: function componentDidMount() {
            ...
            (0, _jsonp2.default)(this.props.source, '', 'callback', function (data) {
                if (data.status) {
                    _this2.setState({
                        imgUrls: data.data
                    });
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.imgUrls.map(function (url) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement('img', { src: url, className: 'img' })
                            );
                        })
                    ),
...
var ComponentOtherapp = function (_Component) {
    _inherits(ComponentOtherapp, _Component);

    function ComponentOtherapp() {
        _classCallCheck(this, ComponentOtherapp);

        var _this = _possibleConstructorReturn(this, (ComponentOtherapp.__proto__ || Object.getPrototypeOf(ComponentOtherapp)).call(this));
    ...
    _createClass(ComponentOtherapp, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var _this2 = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'otherapp-container' },
                _react2.default.createElement(
                    'ul',
                    null,
                    this.state.otherapp.map(function (app) {
                        return _react2.default.createElement(
                            'li',
                            { key: 'app' + countId++ },
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'app_icon' },
                                    _react2.default.createElement('img', { src: app.icon })
                                ),
                                _react2.default.createElement(
                                    'span',
                                    null,
    ...
    return ComponentOtherapp;
}(_react.Component);

exports.default = ComponentOtherapp;
...
var ComponentSpike = function (_Component) {
    _inherits(ComponentSpike, _Component);

    function ComponentSpike() {
        _classCallCheck(this, ComponentSpike);

        var _this = _possibleConstructorReturn(this, (ComponentSpike.__proto__ || Object.getPrototypeOf(ComponentSpike)).call(this));
    ...
    _createClass(ComponentSpike, [{
        ...
        value: function componentDidMount() {
            ...
            var getData = function getData() {
                var promise = new Promise(function (resolve, reject) {
                    (0, _jsonp2.default)(_this2.props.source, '', 'callback', function (data) {
                        if (data.status) {
                            _this2.setState({
            ...
            getData().then(function (times) {
                ...
                var timer = window.setInterval(function () {
                    var _formateTime = _this2.formateTime(times--),
                        hour = _formateTime.hour,
                        minutes = _formateTime.minutes,
                        second = _formateTime.second;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'splike-header' },
                    _react2.default.createElement('i', null),
                    _react2.default.createElement(
                        'span',
                        { className: 'splike-title' },
                        '\u638C\u4E0A\u65F6\u95F4'
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'splike-time' },
                        function () {
                            return _react2.default.createElement(
                                'div',
                                null,
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'splike-content' },
                    this.state.splikeStore.map(function (item) {
                        return _react2.default.createElement(
                            'li',
                            { key: 'splike' + countId++ },
                            _react2.default.createElement(
...
exports.default = ComponentSpike;
...
var ComponentMore = function (_Component) {
    _inherits(ComponentMore, _Component);

    function ComponentMore() {
        _classCallCheck(this, ComponentMore);

        var _this = _possibleConstructorReturn(this, (ComponentMore.__proto__ || Object.getPrototypeOf(ComponentMore)).call(this));
        ...
        value: function componentDidMount() {
            ...
            (0, _jsonp2.default)(this.props.source, '', 'callback', function (data) {
                if (data.status) {
                    ...
                    new _swiperMin2.default('.more-footer .swiper-container', {
                        loop: true,
                        pagination: '.swiper-pagination',
                        paginationClickable: true,
                        autoplay: 2000,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'more-top' },
                    this.state.moreTop.map(function (item) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'more-top-link', key: 'more' + countId++ },
                            _react2.default.createElement(
                                'a',
                                { href: item.url },
                                _react2.default.createElement('img', { src: item.icon })
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'more-middle' },
                    this.state.moreMiddle.map(function (item) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'more-middle-link', key: 'more' + countId++ },
                            _react2.default.createElement(
                                'a',
                                { href: item.url },
                                _react2.default.createElement('img', { src: item.icon })
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'swiper-wrapper' },
                            this.state.moreFooter.map(function (item) {
                                return _react2.default.createElement(
                                    'div',
    ...
    return ComponentMore;
}(_react.Component);

exports.default = ComponentMore;
...
var ComponentLike = function (_Component) {
    _inherits(ComponentLike, _Component);

    function ComponentLike() {
        _classCallCheck(this, ComponentLike);

        var _this = _possibleConstructorReturn(this, (ComponentLike.__proto__ || Object.getPrototypeOf(ComponentLike)).call(this));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.state.data.map(function (item) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'like-content', key: 'like' + countId++ },
                        _react2.default.createElement(
                            'div',
                            { className: 'like-content-link' },
                            _react2.default.createElement(
                                'a',
                                { href: item.url },
                                _react2.default.createElement('img', { src: item.icon })
